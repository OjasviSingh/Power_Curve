...
def display_power_curve():
    try:
        ...
        power_curve_data = analyzer.create_power_curve(activity_type, start_date, num_days, tested_ftp)

        # Assume the plot_power_curve method doesn't require tested_ftp or handle it inside
        plot_path = 'static/power_curve.png'
        analyzer.plot_power_curve(power_curve_data, plot_path)  # Adjust according to actual method definition
